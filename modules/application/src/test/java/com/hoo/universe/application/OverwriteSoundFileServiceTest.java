...
class OverwriteSoundFileServiceTest {
    ...
    OverwriteSoundFileService sut = new OverwriteSoundFileService(loadUniversePort, updateSoundStatusPort, uploadFileAPI, deleteFileEventPublisher);
    ...
    void overwriteSoundAudioService() {
        ...
        // then
        verify(updateSoundStatusPort, times(1)).updateSoundFileOverwrite(any());
    }
